                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <form role="form" action="{{URL::to('/update-admin/'.$pro->ID_NV)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id_loai" class="form-control" id="exampleInputEmail1" value="{{$pro->ID_LOAI}}">
                                </div>
                                <div class="form-group">
