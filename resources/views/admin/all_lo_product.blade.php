  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          @foreach($alllo_product as $key => $pro)
          <tr>
            ...
            <td><span class="text-ellipsis">
              <?php
               if($pro->LO_status==0){
                ?>
                <a href="{{URL::to('/unactivelo-product/'.$pro->ID_LO)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                 }else{
                ?>  
                 <a href="{{URL::to('/activelo-product/'.$pro->ID_LO)}}"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
               }
              ?>
            </span></td>
