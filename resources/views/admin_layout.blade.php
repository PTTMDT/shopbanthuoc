    ...
    <ul class="nav pull-right top-menu"style="backround-color:#32323a;">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('/ttinNV-product')}}"><i class=" fa fa-suitcase"></i>Thông tin</a></li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/customer')}}">Quản lý khách hàng</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-KM-product')}}">Thêm khuyến mãi</a></li>
						<li><a href="{{URL::to('/all-KM-product')}}">Liệt kê khuyến mãi</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-lo-product')}}">Thêm lô</a></li>
						<li><a href="{{URL::to('/all-lo-product')}}">Liệt kê lô</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-NV-product')}}">Thêm nhân viên</a></li>
						<li><a href="{{URL::to('/all-NV-product')}}">Liệt kê nhân viên</a></li>
